...
\catalogtopics{``1. Mineração de Textos. 2. Agrupamento Fuzzy 3. Agrupamento de documentos. 3.
  Organização de documentos. 4.
Mineração de dados. 3. Lógica Fuzzy. 4. Aprendizado de máquina. 5. Inteligência Artificial.''} 
...
\begin{dedicatory}
  Dedico esse trabalho a minha amada mãe, por me dar apoio em todos os momentos em que precisei e ao
  meu amado pai, por ter sido incansável na tarefa de me incentivar ao longo de toda minha vida. 
\end{dedicatory}
...
\begin{keywords}
mineração de textos, agrupamento fuzzy, agrupamento de documentos, organização de documentos,
mineração de dados, lógica fuzzy, aprendizado de máquina, inteligência artificial 
\end{keywords}
...
\begin{keywords}
text mining, fuzzy clustering, documents clustering, documents organization, fuzzy logic, machine
