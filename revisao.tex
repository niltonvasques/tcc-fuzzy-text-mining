...
sistemática de literatura ($SLR\ -\ Sistematic\ Literature\ Review$) utilizadas em \citeonline{Rios2010}.
...
artigos como é o caso do método FCM proposto em \citeonline{Bezdek1984}, são pilares fundamentais
para o tema.
...
A lógica fuzzy foi proposta por Lofti \citeauthoronline{Zadeh1965} para lidar com a incerteza e
imprecisão em diversos problemas do mundo real. A partir desse trabalho desenvolvido por
\citeauthoronline{Zadeh1965}, várias pesquisas se propuseram a explorar os benefícios concedidos pela
...
Segundo \citeonline{Matsumoto10}, os mecanismos adotados em sistemas de recuperação de informação
...
oracle e etc.  Seguindo essa linha de categorização de resultados em SRIs, \citeonline{MarcaciniR10}
...
contexto, as pesquisas apresentadas em \citeonline{Havens2012} e \citeonline{Kumar2015}, são focadas
em bases com imensas quantidades de dados . Segundo \citeonline{Havens2012} existem duas abordagens
...
De acordo com \citeonline{Deng2010}, a organização flexível de dados através do algoritmo FCM possui
...
a inicialização da partição inicial. A respeito do problema da dimensionalidade, \citeonline{Deng2010}
...
\citeonline{Karami2015} propõe um modelo para análise textual de documentos médicos. Um dos pontos
...
otimização de funções objetivos. Contudo, \citeonline{GasparCunha2012} descrevem que a otimização de 
...
Assim sendo \citeonline{Jiang2013} 
...
Segundo \citeonline{Saranya2014}, está presente na literatura uma outra visão do agrupamento textual, que
...
\citeonline{Nogueira2012} cita que uma das principais limitações de um SRI, está na maneira rígida de
...
Seguindo a abordagem de reformulação semântica, em \citeonline{Murali2015} é apresentado um 
...
proposta de \citeonline{Murali2015} ocorre na fase final, quando o usuário realiza uma busca. As palavras
...
SRI, \citeonline{Nogueira2012} propõem um método para gerenciar a precisão e incerteza inerentes a
...
realizada por um usuário. Dada essa importância, \citeonline{Nogueira2013} conduziu uma investigação
...
são extraídos na
fase de pré-processamento ou simultaneamente com o agrupamento. \citeonline{Nogueira2013} destaca que
...
O primeiro método proposto em \citeonline{Nogueira2013} é o SoftO-FDCL (\textit{Soft Organization - Fuzzy Description Comes
...
agrupamento HFCM, \citeonline{Nogueira2013} traz o método HSoftO-FDCL (\textit{Hierarchical Soft
...
Em \citeonline{Yan2013} é informado que em estudos recentes os métodos de co-agrupamento fuzzy,
...
definido em \citeonline{Tjhi2008}, tenta contornar esses problemas, substituindo o $ranking$ dos termos,
